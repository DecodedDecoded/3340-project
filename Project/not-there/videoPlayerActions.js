function likeVideo(button, videoId) {
    ...
    .done(function (data) {
        ...
        if(result.likes < 0) {
            ...
            likeButton.find("img:first").attr("src", "imgs/thumb-up.png");
        }
        else {
            likeButton.find("img:first").attr("src", "imgs/thumb-up-active.png");
        }

        dislikeButton.find("img:first").attr("src", "imgs/thumb-down.png");
...
function dislikeVideo(button, videoId) {
    ...
    .done(function (data) {
        ...
        if(result.dislikes < 0) {
            ...
            dislikeButton.find("img:first").attr("src", "imgs/thumb-down-active.png");
        }
